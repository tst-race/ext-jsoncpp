...
"""
Script to build jsoncpp for RACE
"""
...
def get_cli_arguments():
    ...
    parser = builder.get_arg_parser("jsoncpp", "1.9.5", 1, __file__)
...
if __name__ == "__main__":
    ...
    builder.fetch_source(
        args=args,
        source=f"https://github.com/open-source-parsers/jsoncpp/archive/refs/tags/{args.version}.tar.gz",
        extract="tar.gz",
    )

    source_dir = os.path.join(args.source_dir, f"jsoncpp-{args.version}")
